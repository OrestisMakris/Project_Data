...
float_ocean_data Binary_Interpolation_Search(float_ocean_data *ocean_data , float_ocean_data target  , int n )
{
    int left = 1;
    int right = n-1 ;
    int size ;
...
int main() {
    ...
    clock_t t;
    t = clock();
    temp = Binary_Interpolation_Search (ocean_data, temp, i);
    t = clock() - t;
